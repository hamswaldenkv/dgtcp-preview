...
export default function Page() {
  return (
    <div>
      ...
      <section className="w-[90%] md:container mx-auto py-16">
        <div className="space-y-5">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Sunphenix KYC, the
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Sunphenix,
                Avenue Colonel Ebeya, Kinshasa/Gombe.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Sunphenix, accessible from{" "}
                <a
                  href="https://sunphenix.com/"
          ...
          <ul>
            <li>
              <p>By email: contact@sunphenix.com</p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>By phone number: +243 822 050 048</p>
            </li>
            <li>
              <p>By mail: contact@sunphenix.com</p>
            </li>
          </ul>
        </div>
      </section>
